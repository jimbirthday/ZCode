...
export const resolveBuildAliases = ({
  ...
  "@zcode/shared/product-runtime-identity": resolve(
    rootDirectory,
    "packages/shared/src/product-runtime-identity.ts",
  ),
  "@zcode/shared/product-data-dir": resolve(
    rootDirectory,
    "packages/shared/src/product-data-dir.ts",
  ),
  "@zcode/shared/mgcode-protocol-v4": resolve(
    rootDirectory,
    "packages/shared/src/mgcode-protocol-v4/index.ts",
  ),
  "@zcode/shared/zcode-protocol-v4": resolve(
    rootDirectory,
    "packages/shared/src/mgcode-protocol-v4/index.ts",
  ...
  "@zcode/shared/zcodeEndpoint": resolve(
    rootDirectory,
    "packages/shared/src/mgcodeEndpoint.ts",
  ),
