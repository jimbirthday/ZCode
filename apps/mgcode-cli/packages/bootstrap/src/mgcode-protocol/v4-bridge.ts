...
import { V4CommandExecutor } from "../mgcode-protocol-v4/commands/executor.js";
import { V4QueuePromotionLeaseUnavailableError } from "../mgcode-protocol-v4/commands/handlers/queue.js";
import { V4CapabilityUnsupportedError } from "../mgcode-protocol-v4/commands/handlers/interaction-background.js";
import {
  buildColdFileChangeSummaries,
  readConversationFileChangesFromEvents,
} from "../mgcode-protocol-v4/cold-file-change-summaries.js";
import {
  loadPersistedConversationMaterialization,
  mergeColdConversationEvents,
} from "../mgcode-protocol-v4/cold-event-merge.js";
import { lookupGlobalCreateSessionCommand } from "../mgcode-protocol-v4/create-session-command-fact.js";
import type { V4CommandCoreHost } from "../mgcode-protocol-v4/commands/types.js";
import type {
  ConversationRowTargetResolution,
  SessionUsageSeed,
} from "../mgcode-protocol-v4/product-projection.js";
import { PersistentCommandIndex } from "../mgcode-protocol-v4/persistent-command-index.js";
import { queueItemIdForCommand } from "../mgcode-protocol-v4/command-inbox.js";
import { resolveStableForkTargetFromTranscript } from "../mgcode-protocol-v4/stable-fork-target.js";
import { shouldAutoDrainV4QueueHead } from "../mgcode-protocol-v4/queue-auto-drain.js";
import { persistAssistantFeedback } from "../mgcode-protocol-v4/assistant-feedback-persistence.js";
import {
  TASK_LIST_SESSION_TYPES,
  isTaskListSessionType,
} from "../mgcode-protocol-v4/task-list-session-membership.js";
import {
  loadPersistentCommandFacts,
  savePersistentCommandFact,
} from "../mgcode-protocol-v4/persistent-command-facts.js";
import {
  ConversationV4Gateway,
  V4CommandNotImplementedError,
} from "../mgcode-protocol-v4/v4-gateway.js";
import {
...
import { HYDRATION_TRACE_ID } from "../mgcode-protocol-v4/projection-state.js";
