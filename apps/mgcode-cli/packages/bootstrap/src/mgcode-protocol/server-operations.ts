...
import { inputIntentMetadata } from "../mgcode-protocol-v4/commands/input-intent.js";
...
import { runSessionModelConfigMutation } from "../mgcode-protocol-v4/model-config-mutation.js";
...
async function createRecord(
  ...
  const app = await createWorkspaceZCodeApp(context, workspace, {
    ...
    runtimeConfig: {
      ...
      // desktop-continuous session/create 由 UI 先解析 ~/.mgcode/.agents 的 enabled MCP，
