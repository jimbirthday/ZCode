...
// mgcode-task-types.ts / task-realtime.ts 仍保留旧协议兼容面，共用本文件中的核心类型。

import type { ZCodeBackgroundTaskControlItem } from "./background-task-controls.js";
import type { ToolCallDisplay } from "./mgcode-protocol-v4/toolDisplay.js";
import type {
...
import type { ErrorAttribution } from "./mgcode-protocol-v4/snapshot.js";
