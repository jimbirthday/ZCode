...
} from "./mgcodeTaskIndexSyncer.js";
import { readModelTrajectory } from "./modelTrajectory.js";
import { errorAttributionSchema, type CommandPayloadMap } from "@zcode/shared/mgcode-protocol-v4";
import {
...
function resolveZCodeAgentCurrentLogFilePath(now = new Date()): string {
  ...
  const logDir = configuredLogDir || join(homedir(), ".mgcode", "cli", "log");
