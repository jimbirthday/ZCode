import { resolveZCodeAgentSpawnCwd } from "#src/mgcode-agent/mgcodeAgentSpawnCwd.js";
import type { ZCodeAgentStorageStartupSnapshot } from "#src/mgcode-agent/mgcodeAgent.js";
...
import { ZCodeProtocolClient } from "./mgcodeProtocolClient.js";
import { ZCodeStdioTransport } from "./mgcodeStdioTransport.js";
import { readZCodeStdioTapDevState } from "./mgcodeStdioTapDevConfig.js";
import type { ZCodeAgentPresentationSurface } from "./mgcodeAgentPresentationSurface.js";
...
function resolveDeployedZCodeAgentBinaryCommand(
  ...
  // SSH 远端把 zcode-server.cjs 单文件部署到 ~/.mgcode/server/，宿主进程的 cwd 不在仓库内、
  // env 也不会被 ssh exec 继承，即使 zcode-agent 已经部署到 ~/.mgcode/server/agents/glm/，
  ...
  // packagedResourcesPath、~/.mgcode/server/agents/glm、bundled-agents 等），
