import { requestPluginReferenceCatalog } from "#src/mgcode-agent/pluginReferenceCatalogRequest.js";
import {
...
} from "#src/mgcode-agent/automationToolPolicy.js";
import { ZCODE_AGENT_RUNTIME_UNAVAILABLE_CODE } from "./mgcodeAgent.js";
import type {
...
} from "./mgcodeAgentConnectionScope.js";
import { createBackgroundSessionEventCoalescer } from "#src/mgcode-agent/mgcodeSessionEventCoalescer.js";
...
import { ZCodeAgentMcpStatusModeUnsupportedError } from "#src/mgcode-agent/mgcodeAgentErrors.js";
import { ZCodeAgentProcessManager } from "./mgcodeAgentProcessManager.js";
import {
  createHostCommandEnvelope,
  selectNewSessionWriteProtocol,
} from "./mgcodeV4HostCommand.js";
import type { ZCodeAgentProcessManagerOptions } from "./mgcodeAgentProcessManager.js";
import type { IOffPeakTaskService } from "#src/session/offPeakTask.js";
import {
  ZCodeProtocolRequestTimeoutError,
  type ZCodeProtocolClient,
} from "./mgcodeProtocolClient.js";
import { getDataBaseDir } from "../paths.js";
import {
  collectBrowserAmbientContext,
  type BrowserAmbientContextExecutor,
} from "./mgcodeAgentBrowserAmbientContext.js";
import {
...
function ensurePluginManagementWorkspacePath(): string {
  const workspacePath = join(getDataBaseDir(), ".mgcode", PLUGIN_MANAGEMENT_WORKSPACE_DIR_NAME);
...
// CLI/bootstrap MCP servers configured in ~/.mgcode/cli/config.json (mcp.servers), which the agent
...
export function createZCodeAgentService(
  ...
  // homedir() 即用户家目录，全局根 `~/.mgcode/workflows/` 因此解析到真实目录。
