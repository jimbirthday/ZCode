...
} from "#src/session/mgcodeTaskService.js";
import { createServiceLogger } from "#src/logger/serviceLogger.js";
import {
  readTrajectoryFileTail,
  resolveModelIODirs,
  sanitizeSessionSegment,
} from "#src/mgcode-agent/modelTrajectoryFileTail.js";
import type { TrajectoryFileTail } from "#src/mgcode-agent/modelTrajectoryFileTail.js";
...
/**
 * 解析 ~/.mgcode/cli/{debug,rollout} 下的 model-io JSONL，按 sessionId 还原某个 task 的模型调用轨迹。
 *
 * 设计说明：
