...
export * from "./mgcodeAgentPluginParams.js";
export * from "./mgcodeAgentWorkflowParams.js";
import type {
...
} from "./mgcodeAgentPluginParams.js";
import type {
...
} from "./mgcodeAgentWorkflowParams.js";
...
export interface ZCodeAgentSendPromptParamsBase extends ZCodeAgentSessionTarget {
  ...
  modelExecution?: import("@zcode/shared/mgcode-protocol-v4").CommandPayloadMap["sendText"]["modelExecution"];
  inputId?: string;
  queryId?: string;
  messageId?: string;
  sessionTraceId?: TraceId;
...
export interface IZCodeAgentService {
  ...
  // 已保存工作流的 GUI 中枢：workspace 级、无会话，每次调用现扫 `<cwd>/.mgcode/workflows/`。
