  ...
  const resolved =
    saved === "system"
      ? window.matchMedia("(prefers-color-scheme: dark)").matches
        ? "dark"
        : "light"
      : saved === "dark" || saved === "zai-dark" || saved === "mango"
        ? "dark"
        : "light";
  const appliedTheme =
    saved === "system"
      ...
      : saved === "dark"
        ...
        : saved === "light"
          ? "zai-light"
          : saved;
  document.documentElement.classList.toggle("dark", resolved === "dark" || saved === "mango");
  document.documentElement.classList.toggle("theme-zai-light", appliedTheme === "zai-light");
  document.documentElement.classList.toggle(
    "theme-zai-dark",
    appliedTheme === "zai-dark" || saved === "mango",
  );
  document.documentElement.classList.toggle("theme-mango", saved === "mango");
}
...
async function renderConversationSharePage(): Promise<void> {
  ...
  document.title = routeLocale === "zh-CN" ? "mgcode 会话分享" : "mgcode Conversation Share";
...
async function bootstrapWebApp() {
  ...
  try {
    ...
    document.title = "mgcode - Web + Server";
