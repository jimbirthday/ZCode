...
const zhCN: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "你希望 mgcode 如何呈现工作过程？",
  ...
  "occupationOnboarding.description": "选择最接近你日常工作的一项，让 mgcode 更懂你的工作。",
  ...
  "occupationOnboarding.memoryDescription": "让 mgcode 记住你的偏好与工作上下文。",
  ...
  "startup.global.silent": "正在启动 mgcode",
  ...
  "startup.global.servicesFailed":
    "本地数据准备已完成，但应用服务启动失败。请复制诊断信息，退出并重新打开 mgcode。",
  ...
  "startup.global.starting_services": "正在启动 mgcode",
  "startup.global.ready": "本地数据已就绪",
  "startup.global.failed": "无法完成启动准备",
  "startup.global.help":
    "准备完成后将自动进入 mgcode。历史记录较多时可能需要较长时间，请保持应用运行。",
  ...
  "settings.computerUse.disabledToast": "电脑控制已关闭，已有对话需重启 mgcode 后生效。",
  ...
  "conversationShare.permission.linkEditorHint": "可导入到 mgcode",
  ...
  "conversationShare.import.loginRequired": "该分享暂不支持匿名导入，请登录 mgcode 后重试",
  ...
  "login.title": "欢迎来到 mgcode",
  "login.description": "连接账号，开始使用 mgcode",
  ...
  "login.apiKey.provider.mgoole": "芒果AI · grok-4.7",
  ...
  "login.skip": "暂时跳过",
  "login.account.title": "账号登录",
  "login.account.email": "邮箱",
  "login.account.password": "密码",
  "login.account.captcha": "验证码凭证",
  "login.account.tencentTicket": "腾讯验证码 ticket",
  "login.account.tencentRandstr": "腾讯验证码 randstr",
  "login.account.submit": "登录",
  "login.account.2faLabel": "二次验证码",
  "login.account.2faPlaceholder": "6 位验证码",
  "login.account.confirm2fa": "确认二次验证",
  "login.account.2faFailed": "二次验证未完成",
  "settings.accountTitle": "账号",
  "settings.subscriptionTitle": "订阅",
  "settings.subscription.current": "当前订阅",
  "settings.subscription.currentEmpty": "还没有生效的订阅。",
  "settings.subscription.purchase": "订阅购买",
  "settings.subscription.purchaseEmpty": "暂无可购买的套餐。",
  "settings.subscription.remaining": "剩余",
  "settings.subscription.remainingDays": "剩余 {days} 天",
  "settings.subscription.dayCount": "{days} 天",
  "settings.subscription.price": "价格",
  "settings.subscription.validity": "有效期",
  "settings.subscription.groupsLabel": "可用分组",
  "settings.subscription.expiresToday": "今天到期",
  "settings.subscription.expiresLabel": "到期",
  "settings.subscription.startsLabel": "开始",
  "settings.subscription.expiresAt": "到期 {time}",
  "settings.subscription.startsAt": "开始 {time}",
  "settings.subscription.priceLine": "{price} · {days} 天",
  "settings.subscription.groups": "分组 {names}",
  "settings.subscription.unlimited": "不限",
  "settings.subscription.usedOf": "{used} / {limit}",
  "settings.subscription.usedOnly": "已用 {used}",
  "settings.subscription.reserved": "预留 {amount}",
  "settings.subscription.resetsAt": "{time} 重置",
  "settings.subscription.status.active": "生效中",
  "settings.subscription.status.paused": "已暂停",
  "settings.subscription.status.expired": "已过期",
  "settings.subscription.status.revoked": "已撤销",
  "settings.subscription.quota.daily": "日限额",
  "settings.subscription.quota.weekly": "周限额",
  "settings.subscription.quota.monthly": "月限额",
  "settings.account.balance": "余额",
  "settings.account.frozenBalance": "冻结余额 {amount}",
  "settings.account.recharge": "充值",
  "settings.account.rechargeAction": "创建充值订单",
  "settings.account.amount": "充值金额",
  "settings.account.paymentType": "支付方式",
  "settings.account.order": "订单号",
  "settings.account.openPayUrl": "打开支付链接",
  "settings.account.sharedTitle": "共享订阅",
  "settings.account.upgradeDescription": "选择套餐后会直接打开支付页面。",
  "settings.account.orderOpened": "订单 {orderId} 已创建，但没有可打开的支付页面。",
  "settings.account.sharedEmpty": "还没有共享订阅。",
  "settings.account.sharedEntitlement": "{status} · {days} 天 · 到期 {expires} · {price}",
  "settings.account.sharedPlan": "{days} 天 · {price}",
  "settings.account.renew": "续费",
  "settings.account.buy": "购买",
  ...
  "app.login": "连接使用",
  "app.logout": "断开连接",
  "logout.confirm.title": "断开连接并重启 mgcode？",
  ...
  "modelTrajectory.empty": "暂无模型调用记录（仅 mgcode Agent 会落盘 model-io）",
  ...
  "titleBar.menu.help.about": "关于 mgcode",
  ...
  "forceUpdate.title": "需要升级 mgcode 后继续使用",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "工作区目录不存在或无法访问，当前仅可查看历史记录。恢复该目录后重启 mgcode 即可继续使用。",
  ...
  "ssh.assetInstallModeDescription":
    "远端服务器下载可减少上传等待，但服务器需要能访问 mgcode CDN，并具备下载、解压和校验工具。",
  "ssh.password": "密码",
  ...
  "settings.themeModeDescription": "选择芒果AI、浅色、深色或跟随系统主题。",
  "settings.themeMode.light": "浅色",
  "settings.themeMode.dark": "深色",
  "settings.themeMode.zai-light": "浅色",
  "settings.customTheme.title": "自定义主题",
  "settings.customTheme.description":
    "高级选项：编辑颜色、字体、间距与动效。内置芒果主题请在上方选择。",
  "settings.customTheme.document": "主题配置",
  "settings.customTheme.save": "保存并应用",
  "settings.customTheme.remove": "移除当前主题",
  "settings.themeMode.mango": "芒果AI",
  ...
  "settings.terminalFontFamilyDescription":
    "留空时自动探测系统终端配置；填写后作为 mgcode 终端的字体覆盖。",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "在 mgcode 运行时将后续操作加入队列，或引导至下一轮工具调用后运行。",
  ...
  "settings.dataBaseDirDescription":
    "应用数据的根目录（默认为用户主目录），修改后会将现有数据复制到新位置。路径后缀 .mgcode/v2 不可更改。",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "不能选择 mgcode 安装目录作为数据存储路径。请选择安装目录之外的文件夹。",
  ...
  "sidebar.settings.theme.mango": "芒果AI",
  ...
  "settings.migration.sectionDescription":
    "扫描本机 Claude Code 原生历史，可按 workspace 和时间范围筛选，再把选中的会话导入到对应的 mgcode 任务列表。",
  ...
  "resourceManager.storage.summaryTotal": "mgcode 总占用",
  ...
  "resourceManager.storage.diskUsage": "mgcode 占用 {used}",
  ...
  "settings.browser.desktopOnly": "浏览器数据只能在 mgcode 桌面端管理。",
  ...
  "settings.browser.import.helperVerificationFailed":
    "mgcode 的 Windows 安全导入组件校验失败，Cookie 未导入。请重新安装或更新 mgcode。",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome 在 Windows 上使用 App-Bound 加密保护 Cookie。mgcode 将为本次导入请求管理员权限，临时启动系统服务，完成后立即删除。不会读取或导入 Chrome 密码。",
  ...
  "settings.modelProvider.syncKeys": "一键同步",
  "settings.modelProvider.syncing": "同步中",
  "settings.modelProvider.syncNeedsLogin": "请先登录账号后再同步。",
  "settings.modelProvider.syncEmpty": "没有可同步的可用 API Key。",
  "settings.modelProvider.syncDone": "已同步 {count} 个分组。",
  "settings.mcpTitle": "MCP 服务器",
  "settings.mcp.description": "管理 mgcode Agent 使用的 MCP 服务器配置。",
  ...
  "settings.mcp.host.activeDescription":
    "该 MCP 服务器由 mgcode 宿主为 {pluginName} 插件提供，运行时身份由宿主管理。",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "当前 mgcode Agent 不支持 OAuth 状态刷新。请升级或重启 mgcode，然后重新打开 MCP 设置进行完整刷新。",
  ...
  "settings.mcp.failure.not_authenticated": "当前未登录，请先登录 mgcode。",
  ...
  "settings.mcpServers.import.importing": "正在导入 MCP 服务器到 mgcode",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description": "登录 mgcode 3.x 后开始计时。",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "支持 BYOK、BYOA；Base URL、API Format 和 API Key 由 mgcode 自动维护，无需手动配置。",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "请先在 BigModel 团队套餐管理页添加自己或其他成员，完成后即可在 mgcode 使用团队额度。",
  ...
  "settings.modelProvider.help.contextWindow":
    "模型一次可处理的上下文容量，单位为 Token。mgcode 会据此管理上下文。\n请勿超过模型的实际上限。",
  ...
  "settings.modelProvider.help.followRecommendedConfig":
    "根据模型 ID、Base URL 和 API 格式，为您智能匹配推荐配置。mgcode 会持续更新推荐配置，并自动同步给您。\n如果手动修改某项配置，该项将转为手动管理，不再跟随推荐更新；其他配置仍由智能配置管理。",
  ...
  "settings.usage.billingBanner.description":
    "连接 {provider} 账号后查询编程套餐权益，购买或配置后回到 mgcode 即可继续编码。",
  ...
  "sidebar.usage.plan.viewSubscription": "查看订阅",
  ...
  "sidebar.usage.plan.zcodeMcpDescription": "mgcode 预置插件 MCP 每日合计额度",
  ...
  "settings.skills.import.mode.copy.description":
    "将完整技能目录复制到 mgcode。外部 Agent 目录后续变更不会自动同步。",
  "settings.skills.import.mode.symlink.description":
    "创建指向外部 Agent 技能目录的链接。mgcode 会跟随来源目录后续变更，但该技能依赖来源路径持续可用。",
  "settings.skills.import.importing": "正在导入技能到 mgcode",
  ...
  "settings.promptProfiles.title": "模型提示词",
  "settings.promptProfiles.description":
    "为不同模型编写系统提示词。匹配顺序是指定模型、供应商、模型族，最后是默认。保存后，下一条消息使用这份目录。项目里的 .mgcode/config.json 若也写了 promptProfiles，重启后会按配置合并覆盖这里的用户目录。",
  "settings.promptProfiles.loading": "正在读取提示词…",
  "settings.promptProfiles.empty": "还没有自定义提示词。未添加时，请求继续使用内置提示词。",
  "settings.promptProfiles.add": "添加提示词",
  "settings.promptProfiles.edit": "编辑",
  "settings.promptProfiles.delete": "删除",
  "settings.promptProfiles.save": "保存",
  "settings.promptProfiles.cancel": "取消",
  "settings.promptProfiles.scope": "适用范围",
  "settings.promptProfiles.scope.default": "全部模型",
  "settings.promptProfiles.scope.family": "模型族",
  "settings.promptProfiles.scope.provider": "供应商",
  "settings.promptProfiles.scope.model": "指定模型",
  "settings.promptProfiles.family": "模型族",
  "settings.promptProfiles.provider": "供应商 ID",
  "settings.promptProfiles.model": "模型 ID",
  "settings.promptProfiles.language": "回复语言",
  "settings.promptProfiles.body": "提示词正文",
  "settings.promptProfiles.status.applied": "已保存。下一条消息会使用这份目录。",
  "settings.promptProfiles.status.saved": "已保存。当前没有正在运行的 Agent，下次启动后生效。",
  "settings.promptProfiles.status.applyFailed":
    "已写入配置，但没有推到正在运行的 Agent。重启后会生效。",
  "settings.promptProfiles.error.body": "请填写提示词正文。",
  "settings.promptProfiles.error.language": "请填写回复语言。",
  "settings.promptProfiles.error.family": "请选择模型族。",
  "settings.promptProfiles.error.provider": "请填写供应商 ID。",
  "settings.promptProfiles.error.model": "请填写模型 ID。",
  "settings.promptProfiles.error.duplicate-match": "已经有一条覆盖同一范围的提示词。",
  "settings.promptProfiles.error.invalid": "提示词目录无效。",
  "settings.promptProfiles.error.invalid-json": "用户配置不是有效的 JSON，没有改动文件。",
  "settings.promptProfiles.error.invalid-catalog": "配置里的提示词目录无法读取。",
  "settings.promptProfiles.error.load": "读取或保存提示词失败。",
  "settings.subagents.title": "子智能体",
  "settings.subagents.description": "管理 mgcode Agent 运行时消费的用户级子智能体 Markdown 文件。",
  ...
  "settings.plugins.store.subtitle": "用插件为 mgcode 扩展技能、命令与 MCP 能力",
  ...
  "settings.plugins.import.mode.copy.description":
    "将完整插件目录复制到 mgcode，并注册到 plugins.dirs。外部 Agent 目录后续变更不会自动同步。",
  "settings.plugins.import.mode.symlink.description":
    "创建指向外部 Agent 插件目录的链接，并注册到 plugins.dirs。mgcode 会跟随来源目录后续变更，但该插件依赖来源路径持续可用。",
  "settings.plugins.import.importing": "正在导入插件到 mgcode",
  ...
  "settings.commands.description":
    "管理 mgcode Agent 的 .md 命令文件。命令可通过 /command-name 在聊天中调用。",
  ...
  "settings.commands.import.mode.copy.description":
    "将命令文件复制到 mgcode。外部 Agent 文件后续变更不会自动同步。",
  "settings.commands.import.mode.symlink.description":
    "创建指向外部 Agent 命令文件的链接。mgcode 会跟随来源文件后续变更，但该命令依赖来源路径持续可用。",
  "settings.commands.import.importing": "正在导入命令到 mgcode",
  ...
  "settingsSync.discovery.helper": "仅导入缺失项，不会覆盖当前 mgcode 中已存在的配置。",
  ...
  "onboarding.dialog.title": "欢迎使用 mgcode",
  "onboarding.dialog.description": "选择如何开始第一次会话。",
  "onboarding.wizard.label": "迁移向导",
  "onboarding.welcome.eyebrow": "首次启动设置",
  "onboarding.welcome.title": "欢迎使用 mgcode",
  "onboarding.welcome.start": "开始使用 mgcode",
  ...
  "onboarding.stepDescription.migration": "开始迁移并等待 mgcode 完成导入。",
  ...
  "onboarding.agentsFile.confirmDescription":
    "将从 {source} 复制到 {target}。\n如果目标文件已存在，mgcode 默认 AGENTS 配置会被覆盖。",
  ...
  "chat.placeholder.newTask": "向 mgcode 提问，使用 @ 添加上下文，使用 / 选择命令或能力",
  "chat.placeholder.newTaskMobile": "向 mgcode 提问…",
  ...
  "workflows.hub.empty.hint":
    "在对话里让 mgcode 设计工作流，跑通之后再让它保存到项目里。未打开的项目不会出现在这里。",
  ...
  "workflows.hub.detail.whenToUse.help": "给 mgcode 的路由提示：什么场景该选这个工作流。",
  ...
  "workflows.hub.detail.script.note": "脚本只读。要改脚本，在对话里让 mgcode 修订后另存一版。",
  ...
  "chat.quota.mcp.quotaExhausted": "mgcode MCP「{server}」今日额度已用完，明天自动恢复。",
  "chat.quota.mcp.codingPlanRequired":
    "当前无 mgcode MCP「{server}」额度，请登录或开通 Coding Plan 使用。",
  ...
  "feedback.submit.template.section.copyErrorHeading": "mgcode 报错信息",
  ...
  "offPeak.keepAwakeBanner": "mgcode 运行会话时保持电脑唤醒。",
  ...
  "offPeak.form.instructionsPlaceholder":
    "描述希望 mgcode 在后台完成的工作、预期结果和约束，例如整理本周代码改动并生成站会摘要…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "mgcode 电脑控制仍在准备中——工具尚未加载（已加载 {count} 个）。请先授予下方权限，Helper 就绪后工具会自动出现。",
  "chat.cuaReadiness.toolsPreparing":
    "mgcode 电脑控制仍在准备中——工具尚未加载。请先授予下方权限，Helper 就绪后工具会自动出现。",
  ...
  "cuaPermission.modal.relaunchAppButton": "重启 mgcode",
  "cuaPermission.modal.relaunchAppHint":
    "重启 Helper 后仍未生效？重启 mgcode 可彻底重载 Helper 进程。",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "检测到电脑控制工具，但它们并非来自已校验的 mgcode 官方插件。请检查插件安装后重新验证。",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "首个会话启动时，mgcode 会针对该会话精确验证电脑控制工具。",
