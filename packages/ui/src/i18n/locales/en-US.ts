...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like mgcode to show its work?",
  ...
  "occupationOnboarding.memoryDescription":
    "Let mgcode remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting mgcode",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen mgcode.",
  ...
  "startup.global.starting_services": "Starting mgcode",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "mgcode will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another mgcode or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen mgcode. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen mgcode to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen mgcode.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a mgcode restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into mgcode",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to mgcode and try again",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to mgcode",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to mgcode",
  "login.description": "Connect your account to start using mgcode",
  ...
  "login.account.title": "Account login",
  "login.account.email": "Email",
  "login.account.password": "Password",
  "login.account.captcha": "Captcha proof",
  "login.account.tencentTicket": "Tencent captcha ticket",
  "login.account.tencentRandstr": "Tencent captcha randstr",
  "login.account.submit": "Sign in",
  "login.account.2faLabel": "Second factor",
  "login.account.2faPlaceholder": "6-digit code",
  "login.account.confirm2fa": "Confirm second factor",
  "login.account.2faFailed": "Second factor did not complete",
  "settings.accountTitle": "Account",
  "settings.subscriptionTitle": "Subscription",
  "settings.subscription.current": "Current subscription",
  "settings.subscription.currentEmpty": "No active subscription yet.",
  "settings.subscription.purchase": "Buy a subscription",
  "settings.subscription.purchaseEmpty": "No plans are available.",
  "settings.subscription.remaining": "Remaining",
  "settings.subscription.remainingDays": "{days} days left",
  "settings.subscription.dayCount": "{days} days",
  "settings.subscription.price": "Price",
  "settings.subscription.validity": "Validity",
  "settings.subscription.groupsLabel": "Groups",
  "settings.subscription.expiresToday": "Expires today",
  "settings.subscription.expiresLabel": "Expires",
  "settings.subscription.startsLabel": "Starts",
  "settings.subscription.expiresAt": "Expires {time}",
  "settings.subscription.startsAt": "Starts {time}",
  "settings.subscription.priceLine": "{price} · {days} days",
  "settings.subscription.groups": "Groups {names}",
  "settings.subscription.unlimited": "Unlimited",
  "settings.subscription.usedOf": "{used} / {limit}",
  "settings.subscription.usedOnly": "Used {used}",
  "settings.subscription.reserved": "Reserved {amount}",
  "settings.subscription.resetsAt": "Resets {time}",
  "settings.subscription.status.active": "Active",
  "settings.subscription.status.paused": "Paused",
  "settings.subscription.status.expired": "Expired",
  "settings.subscription.status.revoked": "Revoked",
  "settings.subscription.quota.daily": "Daily limit",
  "settings.subscription.quota.weekly": "Weekly limit",
  "settings.subscription.quota.monthly": "Monthly limit",
  "settings.account.balance": "Balance",
  "settings.account.frozenBalance": "Frozen balance {amount}",
  "settings.account.recharge": "Recharge",
  "settings.account.rechargeAction": "Create recharge order",
  "settings.account.amount": "Amount",
  "settings.account.paymentType": "Payment method",
  "settings.account.order": "Order",
  "settings.account.openPayUrl": "Open payment link",
  "settings.account.sharedTitle": "Shared subscription",
  "settings.account.upgradeDescription": "Choosing a plan opens the payment page directly.",
  "settings.account.orderOpened": "Order {orderId} was created, but there is no payment page to open.",
  "settings.account.sharedEmpty": "No shared subscription yet.",
  "settings.account.sharedEntitlement": "{status} · {days} days · expires {expires} · {price}",
  "settings.account.sharedPlan": "{days} days · {price}",
  "settings.account.renew": "Renew",
  "settings.account.buy": "Buy",
  ...
  "login.apiKey.provider.mgoole": "Mango AI · grok-4.7",
  ...
  "logout.confirm.title": "Disconnect and restart mgcode?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only mgcode Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About mgcode",
  ...
  "forceUpdate.title": "Update mgcode to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart mgcode to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the mgcode CDN and have download, extract, and checksum tools.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "mgcode checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.themeModeDescription": "Choose Mango AI, light, dark, or follow the system theme.",
  "settings.themeMode.light": "Light",
  "settings.themeMode.dark": "Dark",
  "settings.themeMode.zai-light": "Light",
  "settings.customTheme.title": "Custom theme",
  "settings.customTheme.description":
    "Advanced: edit colors, typography, spacing and motion. Select the built-in Mango theme above.",
  "settings.customTheme.document": "Theme document",
  "settings.customTheme.save": "Save and apply",
  "settings.customTheme.remove": "Remove active theme",
  "settings.themeMode.mango": "Mango AI",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the mgcode terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While mgcode is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the mgcode installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "sidebar.settings.theme.mango": "Mango AI",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching mgcode task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by mgcode",
  ...
  "resourceManager.storage.diskUsage": "mgcode uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the mgcode desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "mgcode could not verify its Windows secure import component. Reinstall or update mgcode before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, mgcode will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.modelProvider.syncKeys": "Sync keys",
  "settings.modelProvider.syncing": "Syncing",
  "settings.modelProvider.syncNeedsLogin": "Sign in before syncing keys.",
  "settings.modelProvider.syncEmpty": "No usable API keys to sync.",
  "settings.modelProvider.syncDone": "Synced {count} groups.",
  "settings.mcpTitle": "MCP Servers",
  "settings.mcp.description": "Manage MCP server configurations used by mgcode Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "mgcode provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This mgcode Agent cannot refresh OAuth status. Upgrade or restart mgcode, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to mgcode to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into mgcode",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to mgcode 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by mgcode automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in mgcode.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. mgcode uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in mgcode after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "mgcode MCP",
  ...
  "sidebar.usage.plan.viewSubscription": "View subscription",
  ...
  "sidebar.usage.plan.mcp": "mgcode MCP",
  "sidebar.usage.plan.zcodeMcp": "mgcode MCP",
  "sidebar.usage.plan.zcodeMcpDescription": "Daily aggregate quota for mgcode built-in plugin MCPs",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into mgcode. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. mgcode follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into mgcode",
  ...
  "settings.promptProfiles.add": "Add prompt",
  "settings.promptProfiles.edit": "Edit",
  "settings.promptProfiles.delete": "Delete",
  "settings.promptProfiles.save": "Save",
  "settings.promptProfiles.cancel": "Cancel",
  "settings.promptProfiles.scope": "Applies to",
  "settings.promptProfiles.scope.default": "All models",
  "settings.promptProfiles.scope.family": "Model family",
  "settings.promptProfiles.scope.provider": "Provider",
  "settings.promptProfiles.scope.model": "Specific model",
  "settings.promptProfiles.family": "Family",
  "settings.promptProfiles.provider": "Provider ID",
  "settings.promptProfiles.model": "Model ID",
  "settings.promptProfiles.language": "Reply language",
  "settings.promptProfiles.body": "Prompt body",
  "settings.promptProfiles.status.applied": "Saved. The next message uses this catalog.",
  "settings.promptProfiles.status.saved":
    "Saved. No agent is running, so this applies the next time an agent starts.",
  "settings.promptProfiles.status.applyFailed":
    "Saved to config, but the running agent did not accept it. It applies after restart.",
  "settings.promptProfiles.error.body": "Enter a prompt body.",
  "settings.promptProfiles.error.language": "Enter a reply language.",
  "settings.promptProfiles.error.family": "Choose a model family.",
  "settings.promptProfiles.error.provider": "Enter a provider ID.",
  "settings.promptProfiles.error.model": "Enter a model ID.",
  "settings.promptProfiles.error.duplicate-match": "Another prompt already covers this scope.",
  "settings.promptProfiles.error.invalid": "The prompt catalog is invalid.",
  "settings.promptProfiles.error.invalid-json":
    "The user config is not valid JSON, so the file was left unchanged.",
  "settings.promptProfiles.error.invalid-catalog": "The saved prompt catalog could not be read.",
  "settings.promptProfiles.error.load": "Could not load or save prompts.",
  "settings.subagents.title": "Subagents",
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by mgcode Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend mgcode with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into mgcode and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. mgcode follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into mgcode",
  ...
  "settings.commands.description":
    "Manage mgcode Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.zcodeAgent": "mgcode Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into mgcode. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. mgcode follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into mgcode",
  ...
  "settingsSync.action.finish": "Start using mgcode",
  "settingsSync.agent.zcode": "mgcode Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current mgcode settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to mgcode",
  ...
  "onboarding.welcome.title": "Welcome to mgcode",
  "onboarding.welcome.start": "Start mgcode",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while mgcode imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "mgcode will copy {source} to {target}.\nIf the target file already exists, the mgcode default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask mgcode anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask mgcode anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, mgcode will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want mgcode to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart mgcode app and retry, or ask mgcode to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with mgcode in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for mgcode: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with mgcode in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current mgcode Agent session",
  ...
  "chat.quota.mcp.quotaExhausted":
    'mgcode MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No mgcode MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  "resourceManager.appUsage": "mgcode",
  ...
  "feedback.submit.template.section.copyErrorHeading": "mgcode Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while mgcode is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task mgcode can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "mgcode Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "mgcode Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart mgcode",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart mgcode to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified mgcode plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "mgcode will verify the Computer Use tools against the exact session when your first session starts.",
